...
const unitDefinitions: Record<UnitKey, UnitDefinition> = {
  ...
  box: {
    ...
    drops: [
      ...
      { chance: 10, items: [{ stackable: "apple", amount: 1 }] },
      { chance: 10, items: [{ stackable: "shroom", amount: 1 }] },
      ...
      { chance: 10, items: [{ stackable: "banana", amount: 1 }] },
      { chance: 10, items: [{ stackable: "coconut", amount: 1 }] },
